...
def lecturers(request):
    # Example lecturer data
    lecturers = [
        {'name': 'Dr. John Smith', 'bio': 'An experienced educator in computer science.', 'specialization': 'Artificial Intelligence'},
        {'name': 'Prof. Jane Doe', 'bio': 'Author of numerous engineering books.', 'specialization': 'Mechanical Engineering'},
        {'name': 'Dr. Emily Brown', 'bio': 'A renowned data scientist and mentor.', 'specialization': 'Data Science'}
    ]
    return render(request, 'lecturers.html', {'lecturers': lecturers})
def contacts(request):
    return render(request, 'contacts.html')  # Your Contacts page view
